...
void SubWindow::selectCanvas(MyCanvas *canvas){
    if(!curCanvas){
...
void SubWindow::deleteCanvas(MyCanvas *canvas){
...
void SubWindow::controlWindowScale(){
    if(!maximized){
...
MyCanvas* SubWindow::loadCanvas(const QString &path){
    QFile input(path);
